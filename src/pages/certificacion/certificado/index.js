  ...
  return (
    ...
    <Fragment>
       <Box sx={{ display: 'flex', alignItems: 'center' }}>
              { <img sx={{ display: 'flex', alignItems: 'center' }}   width='1000' height='750' alt='Behance' src='/images/Certificado.png' />
              }
            </Box>
    </Fragment>
...
export default ImpresionCertificado
